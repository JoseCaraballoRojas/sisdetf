...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>S</b>DF</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Sisdetf </b> </span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="/img/logo-sisdetf.png" class="img" alt="User Image"/>
                                        </div>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{asset('/img/logo-sisdetf.png')}}" class="user-image" alt="User Image"/>
                ...
                <!-- Control Sidebar Toggle Button __ opciones de configuracion derecha
                <li>
