...
@section('htmlheader_title', 'Diagnosticar falla arranque')
  ...
  <div class="col-md-9">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="form-signin-heading text-center"><b>Diagnosticar falla de arrancque</b></h3>
      </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="caracteristica">
                    ...
                    <div class="col-md-6 ">
                      ...
                      <div class="form-group ">                      
                        @if($falla->soluciones[1]->solucion)
                          {!! Form::label('caracteristica2',  $falla->soluciones[1]->solucion) !!}
                        @endif
                      </div>
                      <div class="form-group ">                      
                        @if($falla->soluciones[2]->solucion)
                          {!! Form::label('caracteristica2',  $falla->soluciones[2]->solucion) !!}
                        @endif
                      </div>
                    </div>
                    @endforeach
